...
export function SiteHeader() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-ink">
      <div className="dw-container flex h-16 items-center justify-between lg:h-[62px]">
        ...
        <nav className="hidden items-center gap-8 lg:flex xl:gap-10">
          {NAV.map((item) => (
            <Link
              key={item.to}
              to={item.to}
              className="text-[13px] leading-none text-white/70 transition-colors hover:text-white"
